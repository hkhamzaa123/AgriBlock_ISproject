...
mod tests {
    ...
    fn should_pop_single_value() {
        ...
        assert_eq!(transactions[0].data, transaction.data);
    ...
    fn should_pop_multiple_values() {
        ...
        assert_eq!(transactions[0].data, transaction_a.data);
        assert_eq!(transactions[1].data, transaction_b.data);
